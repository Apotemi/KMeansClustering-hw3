...
public class KMeansClusterPanel extends JPanel {
    ...
    public KMeansClusterPanel(File inputFile, int numOfCenter, int numOfIteration) {
        super();
        this.setBackground(Color.lightGray);
        this.colors = getColorArray();

        KMeansCluster clust = new KMeansCluster(inputFile, numOfCenter, numOfIteration);
